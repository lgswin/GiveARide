const globalStyles = {
    ...
    bigTitle: "text-3xl font-bold text-blue-800 mb-2",
    listContainer: "w-full max-w-md p-5 bg-white rounded-lg shadow-md flex-grow overflow-auto mt-4",
    listItem: "p-4 border-b border-gray-300",
    listText: "text-lg text-gray-800",
    scrollWrapper: "w-full max-w-md flex-1 overflow-y-auto",
    leftMarginText: "text-xl text-gray-600 ml-4", // Larger, bold, with left margin
